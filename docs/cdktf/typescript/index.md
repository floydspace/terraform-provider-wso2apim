 ...
 */
import { Wso2ApimProvider } from "./.gen/providers/wso2apim/provider";
class MyConvertedCode extends TerraformStack {
  constructor(scope: Construct, name: string) {
    super(scope, name);
    new Wso2ApimProvider(this, "wso2apim", {
...
- `apiContextPrefix` (String) WSO2 API Manager API Context Prefix.
